...
const displayEmp = empDetails.map((emp)=>{
    // write your code here
    const newArray = [emp.id, emp.name, emp.salary, emp.Bonus, emp.appraisal]
    // const joinedArray = [...newArray.flat()]
...
function getAppraisalPct(maxappraisalscore) {
    ...
    let errorMessage;
    let successMessage;
    // if(!maxappraisalscore || maxappraisalscore<=85){
    //     errorMessage = 'Unfortunately, you are not eligible for a hike'
    //     return errorMessage
    // }else if(maxappraisalscore >= 100){
    //     successMessage = '20% hike to be given'
    //     return successMessage
    // }else if(maxappraisalscore > 90 && maxappraisalscore<100){
    //     successMessage = '10% hike to be given'
    //     return successMessage
    // }else if(maxappraisalscore>85 && maxappraisalscore<= 90) {
    //     successMessage = '5% hike to be given'
    //     return successMessage
    // }
...
// console.log(getAppraisalPct(maxappraisalscore))
