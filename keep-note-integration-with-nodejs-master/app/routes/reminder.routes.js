module.exports = app => {
  ...
  router.route('/').get(reminder.findAll).post(reminder.create).delete(reminder.deleteAll)
  router.route('/:id').get(reminder.findOne).put(reminder.update).delete(reminder.remove)
